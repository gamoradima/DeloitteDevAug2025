	...
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(ButtonActions_caption)#",
					"color": "outline",
					"disabled": false,
					"size": "medium",
			...
			{
				"operation": "insert",
				"name": "CalcAvgMenuItem",
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(CalcAvgMenuItem_caption)#",
					"visible": true,
					"clicked": {
						"request": "crt.RunBusinessProcessRequest",
						"params": {
							"processName": "UsrCalcAverageYachtPrice",
				...
				"parentName": "ButtonActions",
				"propertyName": "menuItems",
				"index": 0
			},
			{
				"operation": "insert",
				"name": "MaxPriceServiceMenuItem",
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MaxPriceServiceMenuItem_caption)#",
					"visible": true,
					"clicked": {
