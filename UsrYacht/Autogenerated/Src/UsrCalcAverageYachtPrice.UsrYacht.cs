namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalcAverageYachtPriceMethodsWrapper

	/// <exclude/>
	public class UsrCalcAverageYachtPriceMethodsWrapper : ProcessModel
	{

		public UsrCalcAverageYachtPriceMethodsWrapper(Process process)
			: base(process) {
